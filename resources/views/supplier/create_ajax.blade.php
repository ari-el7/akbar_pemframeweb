                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            // AUTO RELOAD: Mencoba semua kemungkinan nama variabel tabel Anda
                            if (typeof tableSupplier !== 'undefined') {
                                tableSupplier.ajax.reload();
                            } else if (typeof dataSupplier !== 'undefined') {
                                dataSupplier.ajax.reload();
                            } else {
                                // Jika variabel global tidak ditemukan, reload berdasarkan class
                    ...
                    error: function(xhr) {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'Terjadi kesalahan sistem. Pastikan route dan controller benar.'
                        });
                    }
                });
                return false;
