...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <a href="{{ url('/level/export_excel') }}" class="btn btn-sm btn-primary mt-1">Export Excel</a>
            <a href="{{ url('/level/export_pdf') }}" class="btn btn-sm btn-warning mt-1">Export PDF</a>
