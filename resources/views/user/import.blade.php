        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <small id="error-kategori_id" class="error-text form-text text-muted">Download template excel terlebih dahulu untuk mengisi data</small>
                </div>
                <div class="form-group">
...
<script>
    $(document).ready(function() {
        $("#form-import").validate({
            rules: {
                file_user: { required: true, extension: "xlsx|xls" }
            },
