    ...
    public function list(Request $request)
{
    ...
    public function destroy(string $id) {
        ...
        try {
            ...
            return redirect('/level')->with('error', 'Data gagal dihapus karena masih terkait dengan data lain');
        }
    }
    ...
    public function import_ajax(Request $request) {
        if ($request->ajax() || $request->wantsJson()) {
            $rules = ['file_level' => ['required', 'mimes:xlsx,xls', 'max:1024']];
            $validator = Validator::make($request->all(), $rules);
            if ($validator->fails()) {
    ...
    //     // return 'Update data berhasil. Jumlah data yg di update: '.$row.' baris';
